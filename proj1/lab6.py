...
WEIGHT = np.array([[30, -10, 10, 5, 5, 10, -10, 30],
                   [-10, -50, 4, 3, 3, 4, -50, -10],
                   [10, 4, 7, 2, 2, 7, 4, 10],
                   [5, 3, 2, 1, 1, 2, 3, 5],
                   [5, 3, 2, 1, 1, 2, 3, 5],
...
class AI(object):
    ...
    def go(self, chessboard):
        ...
        if empty < 10:
            ...
            self.start_search(chessboard, alpha, beta, 2)
        else:
            self.start_search(chessboard, alpha, beta, 4)
        # ==================================================================
    ...
    def evaluate(self, chessboard, current_layer, empty):
        ...
        chess_num = self.color_num(chessboard, COLOR_WHITE) - self.color_num(chessboard, COLOR_BLACK)
    ...
    def get_mobility(self, chessboard, color):
        ...
        value = (len(a) - len(b)) / (len(a) + len(b)) + 1  # 0-2
